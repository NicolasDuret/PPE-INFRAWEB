...
Class conteneurJourSemaine
{
	...
	<tbody>';
        foreach ($this->lesJoursSemaine as $joursemaine) {
            $liste = $liste . '
	<tr>
		<td>' . $joursemaine->getLundi() . '</td>
		<td>' . $joursemaine->getMardi() . '</td>
		<td>' . $joursemaine->getMercredi() . '</td>
		<td>' . $joursemaine->getJeudi() . '</td>
		<td>' . $joursemaine->getVendredi() . '</td>
	</tr>';
        }
        $liste = $liste . '
	</tbody>
